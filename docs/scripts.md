...
| `fm-brief.sh`            | Scaffold ship (explicit `--mode`), scout, secondmate-charter, Herdr-lab, and Herdr-retire-session briefs, with Captain's intent and Firstmate spec subsections on ship/scout |
